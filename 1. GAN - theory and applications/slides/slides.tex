...
\begin{frame}
	...
	\begin{itemize}
		...
		\item In \textbf{practice}:  feed $\color{red} y$ into the discriminator and generator.
	\end{itemize}
	\vspace{-0.5cm}
	\begin{figure}
...
\begin{frame}
	...
	\begin{block}{}
		Notice: the same representation of the condition has to be presented to both G and D.
	\end{block}
\end{frame}
