	...
	\begin{itemize}
		...
		\begin{itemize}	
			...
			\begin{equation}
				...
				\tikzmarkend{c}
			\end{equation}}
				\item<2-> \alert<+>{Saturates easily \cite{goodfellowGenerativeAdversarialNetworks2014}.}
				\item<2-> \alert<+>{Change loss for generator:
					\begin{equation}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
		Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.4\paperwidth]{images/p2p/input_15} &
		\includegraphics[height=0.5\paperwidth, width=0.4\paperwidth]{images/p2p/L1cGAN_15}
	\end{tabular}
	\hfil}
	\vfil}
}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
		Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.4\paperwidth]{images/p2p/input_85_7140_to_7097} &
		\includegraphics[height=0.5\paperwidth, width=0.4\paperwidth]{images/p2p/L1cGAN_85_7140_to_7097}
		\end{tabular}
	\hfil}
	\vfil}
}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
	Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.4\paperwidth]{images/p2p/input_12_AB} &
	\includegraphics[height=0.5\paperwidth, width=0.4\paperwidth]{images/p2p/L1cGAN_12_AB}
	\end{tabular}
	\hfil}
	\vfil}
}
