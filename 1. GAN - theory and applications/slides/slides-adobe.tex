...
\author
{ Michele De Simoni \hspace{6cm} @mr\_ubik \and \\ Federico Di Mattia \hspace{6cm} @\_iLeW\_ \and \\ Paolo Galeone \hspace{6cm} @paolo\_galeone \and \\ Emanuele Ghelfi \hspace{6cm} @manughelfi \and \\ \\ \\ \href{https://bit.ly/2Y1nqay}{https://bit.ly/2Y1nqay}}
 ...
 
{
  \usebackgroundtemplate{
  	...
  	\node[anchor=south, opacity=.4, at=(current page.south), shift={(0,0.9)}] {
  		\includegraphics[width=0.5\textwidth]{images/euroscipy_logo.png}};}
  \begin{frame}
    \titlepage
  \end{frame}
}
...
\usebackgroundtemplate{
	...
	\begin{frame}
		...
		\animategraphics[loop,autoplay,width=1\textwidth]{2}{images/spade/}{0}{17}
	\end{frame}
