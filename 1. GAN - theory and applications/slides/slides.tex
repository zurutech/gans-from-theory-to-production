...
\vspace{-0.5cm}
\begin{figure}
	\includegraphics[width=0.35\paperwidth]{images/lecun3.jpg}
\end{figure}
\end{frame}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
		Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth, keepaspectratio]{images/p2p/input_85_7140_to_7097} &
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth, keepaspectratio]{images/p2p/L1cGAN_85_7140_to_7097}
		\end{tabular}
	\hfil}
	\vfil}
}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
	Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth, keepaspectratio]{images/p2p/input_12_AB} &
	\includegraphics[height=0.5\paperwidth, width=0.44\paperwidth, keepaspectratio]{images/p2p/L1cGAN_12_AB}
	\end{tabular}
	\hfil}
	\vfil}
}
