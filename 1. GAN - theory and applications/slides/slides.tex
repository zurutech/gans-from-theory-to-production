...
\begin{frame}
	\animategraphics[loop,autoplay,height=0.9\paperheight]{0.5}{images/stylegan/0990}{00}{10}
\end{frame}
...
\usebeamercolor{normal text}
	...
	%		}
		$$
			J_d =  \underbrace{\frac{1}{m} \sum_{i=1}^{m} \log D(x^{(i)}) + \log(1 - D(G(z^{(i)})))}_{\text{D performance}}
		$$ 
	$$
...
\usebeamercolor{normal text}
	...
	%	\only<2>{$$ \Delta_{\theta_g} \frac{1}{m} \sum_{i=1}^{m} % \underbrace{\log(D(G(z^{(i)})))}_{\text{Generator loss}} $$}
			$$
			\nabla_{\theta_g} \underbrace{\frac{1}{m} \sum_{i=1}^{m} \underbrace{\log(D(G(z^{(i)})))}_{\text{Generator loss}}}_{\text{ Loss estimation}}
			$$}
	\end{enumerate}
\end{frame} 
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
		Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth]{images/p2p/input_15} &
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth]{images/p2p/L1cGAN_15}
	\end{tabular}
	\hfil}
	\vfil}
}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
		Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth]{images/p2p/input_85_7140_to_7097} &
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth]{images/p2p/L1cGAN_85_7140_to_7097}
		\end{tabular}
	\hfil}
	\vfil}
}
...
\usebackgroundtemplate{
	...
	\begin{tabular}{cc}
	Input & Generated \\
		\includegraphics[height=0.5\paperwidth, width=0.45\paperwidth]{images/p2p/input_12_AB} &
	\includegraphics[height=0.5\paperwidth, width=0.44\paperwidth]{images/p2p/L1cGAN_12_AB}
	\end{tabular}
	\hfil}
	\vfil}
}
